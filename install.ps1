<#
    .SYNOPSIS
        Installs the NPSLogFile Module from github

    .DESCRIPTION
        This script installs the NPSLogFile Module from github.
